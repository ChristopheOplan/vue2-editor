  ...
  (function (_BlockEmbed) {
    ...
    function HorizontalRule() {
      ...
      return _possibleConstructorReturn(
        this,
        _getPrototypeOf(HorizontalRule).apply(this, arguments)
      );
    }
      ...
      },
      {
        ...
        value: function onSpace() {
          ...
          if (this.isValid(text, line.domNode.tagName)) {
            ...
            try {
              for (
                var _iterator = this.matches[Symbol.iterator](), _step;
      ...
      },
      {
        ...
        value: function onEnter() {
          ...
          if (this.isValid(text, line.domNode.tagName)) {
            ...
            try {
              for (
                var _iterator2 = this.matches[Symbol.iterator](), _step2;
...
var __vue_render__ = function () {
  ...
  return _c(
    ...
    [
      _vm._t("toolbar"),
      _vm._v(" "),
      _c("div", { ref: "quillContainer", attrs: { id: _vm.id } }),
      _vm._v(" "),
      _vm.useCustomImageHandler
        ? _c("input", {
            ref: "fileInput",
